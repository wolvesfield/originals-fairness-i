 ...
 */
function _hmacSha256(serverSeed: string, clientSeed: string, nonce: number, cursor: number): string {
 ...
 */
function _hashToFloat(hash: string): number {
 ...
 * OPTIMIZED: Uses cached HMAC instance and bitwise extraction.
 */
