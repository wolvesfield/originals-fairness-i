...
export function calculateCrashPoint(serverSeed: string, clientSeed: string, nonce: number): number {
  ...
  // First 13 hex chars: words[0] (8 chars) + words[1] (first 5 chars)
  // words[0] >>> 0 is full 32 bits. words[1] >>> 12 gets the top 20 bits (5 hex chars).
  // Combining them: words[0] * 2^20 + words[1] >>> 12
