...
let floatHmacInstance: CryptoJS.algo.HMAC | null = null;
 ...
 * Optimized with HMAC instance caching and bitwise operations to avoid hex parsing.
 */
...
let crashHmacInstance: CryptoJS.algo.HMAC | null = null;
